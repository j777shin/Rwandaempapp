    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        {user.selectedForPhase2 && currentTrack && (
          <Card className={`mb-6 border-l-4 ${currentTrack.color === "bg-[#00A1DE]" ? "border-l-[#00A1DE]" : "border-l-[#00A651]"}`}>
            <CardHeader className="text-center">
              ...
              <div className="flex items-center justify-center gap-3 mb-2">
                ...
                <Badge variant="outline" className="border-[#FAD201] text-[#FAD201]">Phase 2</Badge>
              </div>
                ...
                <div className="space-y-3">
                  {currentTrack.benefits.map((benefit, index) => (
                    <div key={index} className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                      <CheckCircle2 className={`w-5 h-5 mt-0.5 ${currentTrack.color === "bg-[#00A1DE]" ? "text-[#00A1DE]" : "text-[#00A651]"}`} />
                      <span>{benefit}</span>
                    </div>
                  ))}
                </div>
        ...
        <Card className="mb-6">
          <CardHeader className="text-center">
            <div className="flex justify-center mb-4">
              <div className="w-32 h-32 bg-gradient-to-br from-[#00A1DE] to-[#00A651] rounded-full flex items-center justify-center">
          ...
          <CardContent>
            <div className="text-center mb-8">
              <div className="text-6xl font-bold text-[#00A651] mb-2">{user.totalScore}</div>
              <div className="text-2xl text-muted-foreground mb-4">/100</div>
              <div className={`inline-block px-6 py-2 rounded-full ${user.selectedForPhase2 ? "bg-[#00A651]" : "bg-[#FAD201] text-black"} text-white text-xl`}>
          ...
          <Card className="border-l-4 border-l-[#FAD201]">
            <CardContent className="pt-6">
              <div className="flex items-start gap-4">
                <Award className="w-8 h-8 text-[#FAD201] flex-shrink-0 mt-1" />
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div className="p-4 border-2 border-[#00A1DE] rounded-lg">
                      <div className="flex items-center gap-3 mb-2">
                        <Building2 className="w-6 h-6 text-[#00A1DE]" />
                        <h4 className="font-semibold text-[#00A1DE]">Employment Track</h4>
                      </div>
                      <p className="text-sm text-muted-foreground">Job placement and career development</p>
                    </div>
                    <div className="p-4 border-2 border-[#00A651] rounded-lg">
                      <div className="flex items-center gap-3 mb-2">
                        <Briefcase className="w-6 h-6 text-[#00A651]" />
                        <h4 className="font-semibold text-[#00A651]">Entrepreneurship Track</h4>
                      </div>
