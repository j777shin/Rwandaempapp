...
export function AdminDashboard() {
  const generalActions = [
    ...
    },
    {
      ...
      description: "View and analyze survey responses from beneficiaries",
      link: "/admin/surveys",
      icon: FileText,
    },
  ];
  ...
  const renderCards = (actions: typeof generalActions, cols: string) => (
  ...
  return (
    <div className="p-8 space-y-8 bg-background">
      ...
      <div>
        ...
        {renderCards(generalActions, "md:grid-cols-4")}
      </div>
      ...
      <div>
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Training phase selection and monitoring</p>
          </div>
        </div>
        {renderCards(phase1Actions, "md:grid-cols-2")}
      </div>
      ...
      <div>
        ...
        {renderCards(phase2Actions, "md:grid-cols-3")}
      </div>
    </div>
  );
}
